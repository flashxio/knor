...
public:
    ...
    static void allreduce(const CType* send_buff, const CType* recv_buff,
        ...
        if (ret)
            throw clustercore::mpi_exception("All reduce failure in reduce_double"
                    , ret);
    }
#endif
    ...
    static void reduce_size_t(const size_t* send_buff, size_t* rev_buff,
        ...
        if (ret)
            throw clustercore::mpi_exception("All reduce failure in reduce_size_t"
                    , ret);
    }
    ...
    static void reduce_llong_t(const llong_t* send_buff, size_t* rev_buff,
        ...
        if (ret)
            throw clustercore::mpi_exception("All reduce failure in reduce_llong_t"
                    , ret);
    }
    ...
    static void allgather_double(const double* send_buff,
        ...
        if (ret)
            throw clustercore::mpi_exception("All gather failure in double", ret);
    }
    ...
    static void bcast_double(double* buffer, const int pid,
        ...
        if (ret)
            throw clustercore::mpi_exception("Bcast failure in double", ret);
    }
