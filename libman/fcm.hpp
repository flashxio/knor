...
class fcm : public thread {
    protected:
        ...
        core::dense_matrix<double>* um; // Contribution matrix
        core::dense_matrix<double>* innerprod;
        unsigned nclust;
        unsigned fuzzindex;
    ...
    public:
        static thread::ptr create(
                ...
                const unsigned fuzzindex, core::dense_matrix<double>* um,
                core::dense_matrix<double>* centers,
                const std::string fn, core::dist_t dist_metric) {
            return thread::ptr(
        ...
        void run() override;
        core::dense_matrix<double>* get_innerprod() {
            return innerprod;
        }
        ~fcm();
};
